...
class Scraper:
    ...
    def __init__(
        ...
        Args:
            url (str | Iterable[str]): url or iterable of urls to scrape.
            request_func (Callable[[str], str]): function to request url.
            scrape_func (Callable[[str], str]): function to scrape url contents.
        """
